...
import { ChevronLeft, ChevronRight, Calendar, Award, Users, Rocket, Globe } from "lucide-react"
...
const milestones = [
  ...
  },
  {
    ...
    description: "Opened our first international office, taking on projects from clients around the world",
    icon: Globe,
    image: "/placeholder.svg?height=400&width=600",
...
export default function Journey() {
  ...
  const handleMilestoneClick = (index: number) => {
    ...
    if (timelineRef.current) {
      const milestoneElement = timelineRef.current.children[index] as HTMLElement
      milestoneElement.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "center" })
    }
  }
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            From our humble beginnings to becoming an industry leader, explore the key moments that have shaped Night
            Owls.
          </p>
        </motion.div>
        ...
        <div className="relative mb-12">
          ...
          <div ref={timelineRef} className="flex overflow-x-auto space-x-8 pb-4 scrollbar-hide">
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className={`w-full h-1 mt-2 ${index === activeIndex ? "bg-primary" : "bg-muted"}`} />
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6">{milestones[activeIndex].description}</p>
